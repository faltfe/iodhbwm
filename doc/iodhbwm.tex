...
\documentclass[%
    ...
    \section{Das Paket iodhbwm-templates}\label{pkg:iodhbwm-templates}
        \subsection{Optionen}\label{pkg:options}
            ...
            Die Option gibt die Art des Bachelorabschlusses an und muss daher nur bei \opt{thesis type} = \meta{BA} angegeben werden, wenn der es sich \textbf{nicht} um einen \textit{Bachelor of Engineering} handelt.
            \begin{description}[noitemsep,style=multiline,leftmargin=1cm]
